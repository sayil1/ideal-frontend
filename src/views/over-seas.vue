...
export default {
  ...
  data: () => ({
    ...
    items2: [
      ...
      { text: "United States of Americal", icon: "mdi-arrow-right" },
      { text: "United Arab Emirates", icon: "mdi-arrow-right" },
      { text: "Canada", icon: "mdi-arrow-right" },
      { text: "Germany", icon: "mdi-arrow-right" },
