<template>
  <div style="width:100%">
    ...
    <div class="primary" style="padding:100px;  ">
      <h1 class=" white--text font-weight-bold" style="opacity:0.3">OUR MAJOR GOAL!!</h1>
      <hr class="my-4" />
      <!-- card -->
      <div
        class="card card-size"
        style=";margin:20px;  background: rgba(76, 175, 80, 0.1); border-radius: 25px;
  ...
  border: 2px solid white;"
    ...
    <div class="" style="padding:50px">
      <h1 class="display-3 blue--text font-weight-bold">OUR APPROACH
</h1>
      <hr class="my-4" />
